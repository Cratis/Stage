...
public class when_creating_the_current_frontend_scaffold : a_current_frontend_scaffold
{
    ...
    static string ExpectedDependencyVersions() => string.Join(
        ...
        {
            "@cratis/arc=22.22.0",
            "@cratis/arc.react=22.22.0",
            "@cratis/arc.vite=22.22.0",
            "@cratis/components=4.13.1",
            "@cratis/fundamentals=7.19.4",
            "@cratis/scene.components=4.1.0",
            "@cratis/scene.engine=4.1.0",
            "@cratis/scene.model=4.1.0",
            "@cratis/scene.react=4.1.0",
