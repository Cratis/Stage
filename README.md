...
Cratis/Arc 22.25.0, the verified specification dependencies, an explicit Cratis.Chronicle 19.8.1 client
reference, and `cratis/chronicle:19.8.1-development`. The explicit client reference keeps the client matched to the
