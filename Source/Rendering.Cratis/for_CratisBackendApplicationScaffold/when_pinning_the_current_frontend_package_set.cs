...
public class when_pinning_the_current_frontend_package_set : a_current_scaffold
{
    ...
    [Fact] void should_pin_the_exact_frontend_package_set() => FrontendValues(_frontend).ShouldEqual("22.16.1|22.16.1|22.16.1|7.19.3|7.8.2|4.10.0|0.2.2|19.3.0|19.3.0|7.18.4|8.3.0|7.0.2|6.1.1|19.3.0|19.3.0|4.9.0|3.6.0|11.1.0|8.0.1|3.0.1|26.6.2");
