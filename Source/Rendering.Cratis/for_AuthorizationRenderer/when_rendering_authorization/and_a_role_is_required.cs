...
public class and_a_role_is_required : an_application_with_policies
{
    string _attribute = null!;

    void Because() => _attribute = Render(Authorize("Administrator"));

    [Fact] void should_require_that_role() => _attribute.ShouldEqual("Roles(\"Administrator\")");
