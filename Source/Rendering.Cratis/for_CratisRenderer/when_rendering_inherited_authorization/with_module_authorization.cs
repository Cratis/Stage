...
public class with_module_authorization : an_application_with_authorization
{
    ...
    void Establish()
    {
        ...
        _application = _application with { Modules = [module with { Authorize = new(new PolicyReferenceSyntax("Authenticated", SourceLocation.Start), SourceLocation.Start) }] };
    }
