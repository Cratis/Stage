...
public class when_creating_invalid_frontend_package_sets : Specification
{
    ...
    static CratisFrontendPackageSet Set(
        string arcPackageVersion = "22.22.0",
        string arcReactPackageVersion = "22.22.0",
        string arcVitePackageVersion = "22.22.0",
        string fundamentalsPackageVersion = "7.19.4",
        ...
        string componentsPackageVersion = "4.13.1",
        string scenePackageVersion = "4.1.0",
