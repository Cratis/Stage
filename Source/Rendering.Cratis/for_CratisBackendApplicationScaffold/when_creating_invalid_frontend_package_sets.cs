...
public class when_creating_invalid_frontend_package_sets : Specification
{
    ...
    static CratisFrontendPackageSet Set(
        string arcPackageVersion = "22.23.0",
        string arcReactPackageVersion = "22.23.0",
        string arcVitePackageVersion = "22.23.0",
        string fundamentalsPackageVersion = "7.19.6",
        ...
        string componentsPackageVersion = "4.14.0",
        string scenePackageVersion = "4.2.0",
