...
public class when_creating_the_current_scaffold : a_current_scaffold
{
    ...
    [Fact] void should_pin_the_current_profile() => ProfileValues().ShouldEqual("1|net10.0|22.22.0|22.22.0|22.22.0|4.1.1|4.1.1|18.10.1|6.2.0|2.9.3|4.0.0|19.4.4");
    ...
    [Fact] void should_pin_the_compatible_development_chronicle_image() => Content("docker-compose.yml").ShouldContain("image: cratis/chronicle:19.4.4-development");
    ...
    static string ExpectedPackageVersions() => string.Join(
        ...
        {
            "Cratis=22.22.0",
            "Cratis.Arc.Chronicle.Testing=22.22.0",
            "Cratis.Arc.MongoDB=22.22.0",
            "Cratis.Chronicle=19.4.4",
            "Cratis.Chronicle.AspNetCore=19.4.4",
            "Cratis.Chronicle.Testing=19.4.4",
