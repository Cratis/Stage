...
/// <summary>
/// The exception that is thrown when a Screenplay screen mixes a top-level <c language="csharp">template</c> directive with
/// other top-level directives. Every current <c language="csharp">screens.md</c> example has a screen's top-level directives
/// be either exactly one <c language="csharp">template</c> reference, or a flat list with no <c language="csharp">template</c> reference at all -
